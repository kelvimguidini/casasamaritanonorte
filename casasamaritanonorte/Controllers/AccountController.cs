...
namespace casasamaritanonorte.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (returnUrl == null || returnUrl.Substring(0, 1) == "#")
            {
                returnUrl = Url.Action("Index", "Campanhas");
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                enviaEmail.EnviarEmail("Foi solicitado uma alteração de senha para esse e-mail no sistema da casa de repouso o bom samaritano norte </br></br> Redefina sua senha, clicando <a href=\"" + callbackUrl + "\">aqui</a></b></br></br>", model.Email, "Recuperação de senha casa de repouso o bom samaritano");
